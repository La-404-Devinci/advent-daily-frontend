...
export default function UserClassement({ user }) {
    return (
        <div className="flex items-center gap-3 p-4 border border-gray-800 bg-gray-900/75 rounded-2xl relative">
            <div className="flex items-center justify-center flex-col px-2 py-1 h-6 absolute -top-3 left-3 bg-blue-950
             rounded-lg">
                <p className="text-gray-300 text-center font-normal text-xs">
                    {user.place}.
                </p>
            </div>
