        ...
        <Layout>
            <div className="flex flex-col gap-40 min-h-screen px-6 py-32 text-center w-full">
                <div>
                    ...
                    <p className="mt-4 text-sm text-gray-300">Rentre un mot de passe sécurisé pour continuer ton
                        inscription.</p>
                    ...
                    <div className="flex flex-col items-start max-w-full gap-4">
                        <div className="flex flex-col items-start w-full">
                            ...
                            <div className="w-full">
                                ...
                                <ul className="flex flex-col gap-1.5 mt-4 bg-gray-900/50 border border-gray-800 rounded-lg p-2"
